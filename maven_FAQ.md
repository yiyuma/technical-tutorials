...
Wenn man mvn phase in Command line eingibt, wird Maven die eingegebene Phase und die Phases, die vor dieser Phase stehen, ausführen. Vorausgesetzt, die Phase mit ein goal aus Plugin angebunden ist. 

Was ist der Unterschied zwischen Dependencies und DependencyManagement?<br>
...
```
Effective settings wird angezeigt.<br>
